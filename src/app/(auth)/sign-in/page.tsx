        ...
        <>
            <div className=" h-[100vh] w-[100vw] flex flex-col justify-center items-center  bg-neutral-300">
                <div data-theme='light' className="flex !md:w-[400px] flex-col shadow-xl bg-neutral-200 justify-center items-center p-12 rounded-md" >
                    ...
                    <div className='email p-2 flex flex-col md:flex-row' >
                        <label className="p-3 w-[120px]" htmlFor="email">Identifier</label>
                        <input onChange={(e) => {
                            e.preventDefault()
                            setText(e.target.value)
                        }} placeholder="email or username" className='border-2 p-2 rounded-full' name='email' type="email" />
                    </div>
                    <div className='password p-2 flex flex-col md:flex-row' >
                        <label className="p-3 w-[120px]" htmlFor="password">Password</label>
                        <input onChange={(e) => {
                            e.preventDefault()
                            setPassword(e.target.value)
                        }} placeholder="123456" className='border-2 p-2 rounded-full' name='password' type="password" />
                    </div>
